...
public class modelGui {
     ...
     */
    public modelGui(double radius, double x, double y) {
        this.radius = radius;
        this.x = x;
        this.y = y;
    }
     ...
     */
    public boolean equals(modelGui other) {
     ...
     */
    public boolean isInside(modelGui other) {
     ...
     * of the circle.
     *
     * @param modelGui The other circle.
     * @return Distance between the centers of the two circles.
     */
    private double distance(modelGui other) {
    ...
    public String toString() {
        return "modelGui: radius " + radius + ", location (" + x + "," + y + ")";
    }
}